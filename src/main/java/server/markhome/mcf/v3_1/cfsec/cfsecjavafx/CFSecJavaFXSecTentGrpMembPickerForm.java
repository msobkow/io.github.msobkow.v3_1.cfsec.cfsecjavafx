// Description: Java 25 JavaFX Picker Form implementation for SecTentGrpMemb.
...
/**
 *	CFSecJavaFXSecTentGrpMembPickerForm JavaFX Picker Form implementation
 *	for SecTentGrpMemb.
 */
public class CFSecJavaFXSecTentGrpMembPickerForm
	...
	ICFForm
{
		...
		ICFSecJavaFXSecTentGrpMembChosen whenChosen )
	{
		...
		javafxPickerPane = argSchema.getSecTentGrpMembFactory().newPickerPane( cfFormManager, argFocus, argContainer, argPageCallback, whenChosen );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecTentGrpMembPaneCommon)javafxPickerPane).setJavaFXFocus( (ICFSecSecTentGrpMembObj)value );
	}
	...
	public Collection<ICFSecSecTentGrpMembObj> getJavaFXDataCollection() {
		...
		Collection<ICFSecSecTentGrpMembObj> cltn = jplPicker.getJavaFXDataCollection();
		return( cltn );
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( javafxPickerPane != null ) {
			ICFSecJavaFXSecTentGrpMembPaneCommon jpanelCommon = (ICFSecJavaFXSecTentGrpMembPaneCommon)javafxPickerPane;
