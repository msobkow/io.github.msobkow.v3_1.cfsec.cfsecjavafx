// Description: Java 25 JavaFX View/Edit Pane implementation for SecClusGrpInc.
...
/**
 *	CFSecJavaFXSecClusGrpIncViewEditPane JavaFX View/Edit Pane implementation
 *	for SecClusGrpInc.
 */
public class CFSecJavaFXSecClusGrpIncViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecClusGrpIncPaneCommon
{
	...
	public CFSecJavaFXSecClusGrpIncViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusGrpIncObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecClusGrpIncPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
