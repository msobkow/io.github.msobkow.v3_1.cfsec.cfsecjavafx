// Description: Java 25 JavaFX Add Form implementation for SecRole.
...
/**
 *	CFSecJavaFXSecRoleAddForm JavaFX Add Form implementation
 *	for SecRole.
 */
public class CFSecJavaFXSecRoleAddForm
extends CFBorderPane
implements ICFSecJavaFXSecRolePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Security Role";
	...
	public CFSecJavaFXSecRoleAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecRoleObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecRoleObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxAddPane = argSchema.getSecRoleFactory().newAddPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecSecRoleEditObj editObj = (ICFSecSecRoleEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecRolePaneCommon)javafxAddPane).setJavaFXFocus( value );
		ICFSecSecRoleObj argFocus = (ICFSecSecRoleObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecRoleObj)argFocus.read( true );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						focus = getJavaFXFocusAsSecRole();
						CFBorderPane frame = javafxSchema.getSecRoleFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecRolePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecRolePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
