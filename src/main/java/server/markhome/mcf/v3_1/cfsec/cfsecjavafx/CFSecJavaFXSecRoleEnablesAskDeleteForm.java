// Description: Java 25 JavaFX Ask Delete Pane implementation for SecRoleEnables.
...
/**
 *	CFSecJavaFXSecRoleEnablesAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecRoleEnables.
 */
public class CFSecJavaFXSecRoleEnablesAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecRoleEnablesPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Security Role Enables Group";
	...
	public CFSecJavaFXSecRoleEnablesAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecRoleEnablesObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Security Role Enables Group?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecRoleEnablesObj obj = getJavaFXFocusAsSecRoleEnables();
					ICFSecSecRoleEnablesEditObj editObj = (ICFSecSecRoleEnablesEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecRoleEnablesFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecRoleEnables( ICFSecSecRoleEnablesObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecRoleEnablesPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecRoleEnablesPaneCommon)attrPane).setPaneMode( value );
		}
	}
