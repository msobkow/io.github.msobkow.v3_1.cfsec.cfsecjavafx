// Description: Java 25 JavaFX Picker of Obj Pane implementation for SecClusGrpInc.
...
/**
 *	CFSecJavaFXSecClusGrpIncPickerPane JavaFX Pick Obj Pane implementation
 *	for SecClusGrpInc.
 */
public class CFSecJavaFXSecClusGrpIncPickerPane
extends CFBorderPane
implements ICFSecJavaFXSecClusGrpIncPaneList
{
	public static String S_FormName = "Choose Cluster Security Group Include";
		...
		buttonChooseNone.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseSecClusGrpInc( null );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
		...
		buttonChooseSelected.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseSecClusGrpInc( selectedInstance );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
