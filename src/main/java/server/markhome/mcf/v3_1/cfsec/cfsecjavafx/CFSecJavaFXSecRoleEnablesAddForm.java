// Description: Java 25 JavaFX Add Form implementation for SecRoleEnables.
...
/**
 *	CFSecJavaFXSecRoleEnablesAddForm JavaFX Add Form implementation
 *	for SecRoleEnables.
 */
public class CFSecJavaFXSecRoleEnablesAddForm
extends CFBorderPane
implements ICFSecJavaFXSecRoleEnablesPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Security Role Enables Group";
	...
	public CFSecJavaFXSecRoleEnablesAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecRoleEnablesObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecRoleEnablesFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecRoleEnablesPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecRoleEnablesFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecRoleEnablesPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecRoleEnablesPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
