// Description: Java 25 JavaFX View/Edit Form implementation for SecTentGrpInc.
...
/**
 *	CFSecJavaFXSecTentGrpIncViewEditForm JavaFX View/Edit Form implementation
 *	for SecTentGrpInc.
 */
public class CFSecJavaFXSecTentGrpIncViewEditForm
	...
	ICFForm
{
	...
	public CFSecJavaFXSecTentGrpIncViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentGrpIncObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecTentGrpIncObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getSecTentGrpIncFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecSecTentGrpIncEditObj editObj = (ICFSecSecTentGrpIncEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecTentGrpIncPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFSecSecTentGrpIncObj argFocus = (ICFSecSecTentGrpIncObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecTentGrpIncObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsSecTentGrpInc() != null ) {
							if( null == getJavaFXFocusAsSecTentGrpInc().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsSecTentGrpInc();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentGrpIncPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecTentGrpIncPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
