// Description: Java 25 JavaFX Ask Delete Pane implementation for SecClusGrpInc.
...
/**
 *	CFSecJavaFXSecClusGrpIncAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecClusGrpInc.
 */
public class CFSecJavaFXSecClusGrpIncAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecClusGrpIncPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Cluster Security Group Include";
	...
	public CFSecJavaFXSecClusGrpIncAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusGrpIncObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Cluster Security Group Include?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecClusGrpIncObj obj = getJavaFXFocusAsSecClusGrpInc();
					ICFSecSecClusGrpIncEditObj editObj = (ICFSecSecClusGrpIncEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecClusGrpIncFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecClusGrpInc( ICFSecSecClusGrpIncObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecClusGrpIncPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecClusGrpIncPaneCommon)attrPane).setPaneMode( value );
		}
	}
