// Description: Java 25 JavaFX Picker Form implementation for SecUserPassword.
...
/**
 *	CFSecJavaFXSecUserPasswordPickerForm JavaFX Picker Form implementation
 *	for SecUserPassword.
 */
public class CFSecJavaFXSecUserPasswordPickerForm
	...
	ICFForm
{
		...
		ICFSecJavaFXSecUserPasswordChosen whenChosen )
	{
		...
		javafxPickerPane = argSchema.getSecUserPasswordFactory().newPickerPane( cfFormManager, argFocus, argContainer, argDataCollection, whenChosen );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecUserPasswordPaneCommon)javafxPickerPane).setJavaFXFocus( (ICFSecSecUserPasswordObj)value );
	}
	...
	public Collection<ICFSecSecUserPasswordObj> getJavaFXDataCollection() {
		...
		Collection<ICFSecSecUserPasswordObj> cltn = jplPicker.getJavaFXDataCollection();
		return( cltn );
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( javafxPickerPane != null ) {
			ICFSecJavaFXSecUserPasswordPaneCommon jpanelCommon = (ICFSecJavaFXSecUserPasswordPaneCommon)javafxPickerPane;
