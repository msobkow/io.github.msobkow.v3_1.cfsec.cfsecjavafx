// Description: Java 25 JavaFX Picker Form implementation for SecTentGrp.
...
/**
 *	CFSecJavaFXSecTentGrpPickerForm JavaFX Picker Form implementation
 *	for SecTentGrp.
 */
public class CFSecJavaFXSecTentGrpPickerForm
	...
	ICFForm
{
		...
		ICFSecJavaFXSecTentGrpChosen whenChosen )
	{
		...
		javafxPickerPane = argSchema.getSecTentGrpFactory().newPickerPane( cfFormManager, argFocus, argContainer, argDataCollection, whenChosen );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecTentGrpPaneCommon)javafxPickerPane).setJavaFXFocus( (ICFSecSecTentGrpObj)value );
	}
	...
	public Collection<ICFSecSecTentGrpObj> getJavaFXDataCollection() {
		...
		Collection<ICFSecSecTentGrpObj> cltn = jplPicker.getJavaFXDataCollection();
		return( cltn );
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( javafxPickerPane != null ) {
			ICFSecJavaFXSecTentGrpPaneCommon jpanelCommon = (ICFSecJavaFXSecTentGrpPaneCommon)javafxPickerPane;
