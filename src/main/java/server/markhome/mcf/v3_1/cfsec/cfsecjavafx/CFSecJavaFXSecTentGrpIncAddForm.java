// Description: Java 25 JavaFX Add Form implementation for SecTentGrpInc.
...
/**
 *	CFSecJavaFXSecTentGrpIncAddForm JavaFX Add Form implementation
 *	for SecTentGrpInc.
 */
public class CFSecJavaFXSecTentGrpIncAddForm
	...
	ICFForm
{
	...
	public CFSecJavaFXSecTentGrpIncAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentGrpIncObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecTentGrpIncFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecTentGrpIncPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecTentGrpIncFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentGrpIncPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecTentGrpIncPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
