// Description: Java 25 JavaFX View/Edit Pane implementation for SecTentGrpInc.
...
/**
 *	CFSecJavaFXSecTentGrpIncViewEditPane JavaFX View/Edit Pane implementation
 *	for SecTentGrpInc.
 */
public class CFSecJavaFXSecTentGrpIncViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecTentGrpIncPaneCommon
{
	...
	public CFSecJavaFXSecTentGrpIncViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentGrpIncObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentGrpIncPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
