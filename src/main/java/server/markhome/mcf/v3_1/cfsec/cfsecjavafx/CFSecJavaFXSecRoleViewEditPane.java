// Description: Java 25 JavaFX View/Edit Pane implementation for SecRole.
...
/**
 *	CFSecJavaFXSecRoleViewEditPane JavaFX View/Edit Pane implementation
 *	for SecRole.
 */
public class CFSecJavaFXSecRoleViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecRolePaneCommon
{
	...
	public CFSecJavaFXSecRoleViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecRoleObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getSecRoleFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecRolePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecRolePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFSecJavaFXSecRolePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
