// Description: Java 25 JavaFX List of Obj Pane implementation for SecTentRole.
...
/**
 *	CFSecJavaFXSecTentRoleListPane JavaFX List of Obj Pane implementation
 *	for SecTentRole.
 */
public class CFSecJavaFXSecTentRoleListPane
extends CFBorderPane
implements ICFSecJavaFXSecTentRolePaneList
{
	public static String S_FormName = "List Tenant Security Role";
		...
		boolean sortByChain )
	{
		...
		if( observableListOfSecTentRole != null ) {
	...
	public void adjustListButtons() {
		...
		if( buttonAddSecTentRole != null ) {
			buttonAddSecTentRole.setDisable( ! allowAdds );
		}
