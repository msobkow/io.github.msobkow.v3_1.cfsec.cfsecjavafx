// Description: Java 25 JavaFX View/Edit Pane implementation for SecRoleEnables.
...
/**
 *	CFSecJavaFXSecRoleEnablesViewEditPane JavaFX View/Edit Pane implementation
 *	for SecRoleEnables.
 */
public class CFSecJavaFXSecRoleEnablesViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecRoleEnablesPaneCommon
{
	...
	public CFSecJavaFXSecRoleEnablesViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecRoleEnablesObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecRoleEnablesPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
