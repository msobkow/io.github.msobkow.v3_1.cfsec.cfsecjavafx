// Description: Java 25 JavaFX Picker Form implementation for SecClusGrp.
...
/**
 *	CFSecJavaFXSecClusGrpPickerForm JavaFX Picker Form implementation
 *	for SecClusGrp.
 */
public class CFSecJavaFXSecClusGrpPickerForm
	...
	ICFForm
{
	...
	public CFSecJavaFXSecClusGrpPickerForm( ICFFormManager formManager,
		...
		ICFSecJavaFXSecClusGrpChosen whenChosen )
	{
		...
		javafxPickerPane = argSchema.getSecClusGrpFactory().newPickerPane( cfFormManager, argFocus, argContainer, argDataCollection, whenChosen );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecClusGrpPaneCommon)javafxPickerPane).setJavaFXFocus( (ICFSecSecClusGrpObj)value );
	}
	...
	public Collection<ICFSecSecClusGrpObj> getJavaFXDataCollection() {
		ICFSecJavaFXSecClusGrpPaneList jplPicker = (ICFSecJavaFXSecClusGrpPaneList)javafxPickerPane;
		Collection<ICFSecSecClusGrpObj> cltn = jplPicker.getJavaFXDataCollection();
		return( cltn );
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( javafxPickerPane != null ) {
			ICFSecJavaFXSecClusGrpPaneCommon jpanelCommon = (ICFSecJavaFXSecClusGrpPaneCommon)javafxPickerPane;
