// Description: Java 25 JavaFX Add Pane implementation for SecTentGrpInc.
...
/**
 *	CFSecJavaFXSecTentGrpIncAddPane JavaFX Add Pane implementation
 *	for SecTentGrpInc.
 */
public class CFSecJavaFXSecTentGrpIncAddPane
extends CFSplitPane
implements ICFSecJavaFXSecTentGrpIncPaneCommon
{
	...
	public CFSecJavaFXSecTentGrpIncAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentGrpIncObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentGrpIncPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
