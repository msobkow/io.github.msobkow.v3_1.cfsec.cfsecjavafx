// Description: Java 25 JavaFX Ask Delete Pane implementation for SecRoleMemb.
...
/**
 *	CFSecJavaFXSecRoleMembAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecRoleMemb.
 */
public class CFSecJavaFXSecRoleMembAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecRoleMembPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Security Role Member";
	...
	public CFSecJavaFXSecRoleMembAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecRoleMembObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Security Role Member?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecRoleMembObj obj = getJavaFXFocusAsSecRoleMemb();
					ICFSecSecRoleMembEditObj editObj = (ICFSecSecRoleMembEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecRoleMembFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecRoleMemb( ICFSecSecRoleMembObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecRoleMembPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecRoleMembPaneCommon)attrPane).setPaneMode( value );
		}
	}
