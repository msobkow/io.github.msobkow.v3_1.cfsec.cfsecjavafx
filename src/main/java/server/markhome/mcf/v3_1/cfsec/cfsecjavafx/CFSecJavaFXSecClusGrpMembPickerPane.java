// Description: Java 25 JavaFX Picker of Obj Pane implementation for SecClusGrpMemb.
...
/**
 *	CFSecJavaFXSecClusGrpMembPickerPane JavaFX Pick Obj Pane implementation
 *	for SecClusGrpMemb.
 */
public class CFSecJavaFXSecClusGrpMembPickerPane
extends CFBorderPane
implements ICFSecJavaFXSecClusGrpMembPaneList
{
	public static String S_FormName = "Choose Cluster Security Group Member";
	...
	protected ICFSecJavaFXSecClusGrpMembChosen invokeWhenChosen = null;
	protected ICFLibAnyObj javafxContainer = null;
	protected CFButton buttonCancel = null;
	protected CFButton buttonChooseNone = null;
	protected CFButton buttonChooseSelected = null;
	protected ScrollPane scrollMenu = null;
	public CFSecJavaFXSecClusGrpMembPickerPane( ICFFormManager formManager,
		...
		buttonChooseNone.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseSecClusGrpMemb( null );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
		...
		buttonChooseSelected.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseSecClusGrpMemb( selectedInstance );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
