// Description: Java 25 JavaFX Add Pane implementation for SecRole.
...
/**
 *	CFSecJavaFXSecRoleAddPane JavaFX Add Pane implementation
 *	for SecRole.
 */
public class CFSecJavaFXSecRoleAddPane
extends CFSplitPane
implements ICFSecJavaFXSecRolePaneCommon
{
	...
	public CFSecJavaFXSecRoleAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecRoleObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecRolePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
