// Description: Java 25 JavaFX Finder Form implementation for SecClusGrpInc.
...
/**
 *	CFSecJavaFXSecClusGrpIncFinderForm JavaFX Finder Form implementation
 *	for SecClusGrpInc.
 */
public class CFSecJavaFXSecClusGrpIncFinderForm
extends CFBorderPane
implements ICFSecJavaFXSecClusGrpIncPaneCommon,
	ICFForm
{
	public static String S_FormName = "Find Cluster Security Group Include";
	...
	protected CFButton buttonAddSecClusGrpInc = null;
	protected CFButton buttonViewSelected = null;
	protected CFButton buttonEditSelected = null;
	protected CFButton buttonClose = null;
	protected CFButton buttonDeleteSelected = null;
	protected ICFSecJavaFXSecClusGrpIncPageCallback pageCallback = null;
	...
	{
		public PageDataSecClusGrpIncList() {
		}
	...
	public CFSecJavaFXSecClusGrpIncFinderForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema ) {
		super();
		...
		pageCallback = new PageDataSecClusGrpIncList();
		...
		dataTable.getSelectionModel().selectedItemProperty().addListener(
			new ChangeListener<ICFSecSecClusGrpIncObj>() {
				@Override public void changed( ObservableValue<? extends ICFSecSecClusGrpIncObj> observable,
					ICFSecSecClusGrpIncObj oldValue,
					ICFSecSecClusGrpIncObj newValue )
				{
		...
		if( hboxMenu == null ) {
			...
			buttonMoreData.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					final String S_ProcName = "handle";
					try {
						ICFSecSecClusGrpIncObj lastObj = null;
						if( ( observableListOfSecClusGrpInc != null ) && ( observableListOfSecClusGrpInc.size() > 0 ) ) {
							lastObj = observableListOfSecClusGrpInc.get( observableListOfSecClusGrpInc.size() - 1 );
						}
						...
						Iterator<ICFSecSecClusGrpIncObj> iter = page.iterator();
						while( iter.hasNext() ) {
							observableListOfSecClusGrpInc.add( iter.next() );
						}
						if( page.size() < 25 ) {
							observableListOfSecClusGrpInc.sort( compareSecClusGrpIncByQualName );
							endOfData = true;
						}
						else {
							endOfData = false;
						...
						if( dataTable != null ) {
							dataTable.setItems( observableListOfSecClusGrpInc );
			...
			buttonAddSecClusGrpInc = new CFButton();
			buttonAddSecClusGrpInc.setMinWidth( 200 );
			buttonAddSecClusGrpInc.setText( "Add Cluster Security Group Include..." );
			buttonAddSecClusGrpInc.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					final String S_ProcName = "handle";
					try {
						ICFSecSchemaObj schemaObj = (ICFSecSchemaObj)javafxSchema.getSchema();
						...
						ICFSecSecClusGrpIncObj obj = (ICFSecSecClusGrpIncObj)schemaObj.getSecClusGrpIncTableObj().newInstance();
						ICFSecSecClusGrpIncEditObj edit = (ICFSecSecClusGrpIncEditObj)( obj.beginEdit() );
						if( edit == null ) {
							throw new CFLibNullArgumentException( getClass(),
								S_ProcName,
								0,
						...
						CFBorderPane frame = javafxSchema.getSecClusGrpIncFactory().newAddForm( cfFormManager, obj, getViewEditClosedCallback(), true );
						ICFSecJavaFXSecClusGrpIncPaneCommon jpanelCommon = (ICFSecJavaFXSecClusGrpIncPaneCommon)frame;
			...
			hboxMenu.getChildren().add( buttonAddSecClusGrpInc );
			...
			buttonViewSelected.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						ICFSecSecClusGrpIncObj selectedInstance = getJavaFXFocusAsSecClusGrpInc();
						if( selectedInstance != null ) {
							int classCode = selectedInstance.getClassCode();
							ICFSecSchema.ClassMapEntry entry = ICFSecSchema.getClassMapByRuntimeClassCode(classCode);
							int backingClassCode = entry.getBackingClassCode();
							if( entry.getSchemaName().equals("CFSec") && backingClassCode == ICFSecSecClusGrpInc.CLASS_CODE ) {
								CFBorderPane frame = javafxSchema.getSecClusGrpIncFactory().newViewEditForm( cfFormManager, selectedInstance, getViewEditClosedCallback(), false );
								((ICFSecJavaFXSecClusGrpIncPaneCommon)frame).setPaneMode( CFPane.PaneMode.View );
								cfFormManager.pushForm( frame );
							}
							else {
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFSec") && backingClassCode == ICFSecSecClusGrpInc.CLASS_CODE ) {
								CFBorderPane frame = javafxSchema.getSecClusGrpIncFactory().newViewEditForm( cfFormManager, selectedInstance, getViewEditClosedCallback(), false );
								((ICFSecJavaFXSecClusGrpIncPaneCommon)frame).setPaneMode( CFPane.PaneMode.Edit );
								cfFormManager.pushForm( frame );
							}
							else {
								throw new CFLibUnsupportedClassException( getClass(),
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							int backingClassCode = entry.getBackingClassCode();
							if( entry.getSchemaName().equals("CFSec") && backingClassCode == ICFSecSecClusGrpInc.CLASS_CODE ) {
								CFBorderPane frame = javafxSchema.getSecClusGrpIncFactory().newAskDeleteForm( cfFormManager, selectedInstance, getDeleteCallback() );
								((ICFSecJavaFXSecClusGrpIncPaneCommon)frame).setPaneMode( CFPane.PaneMode.View );
								cfFormManager.pushForm( frame );
							}
							else {
	...
	public void adjustFinderButtons() {
		ICFSecSecClusGrpIncObj selectedObj = getJavaFXFocusAsSecClusGrpInc();
		...
		if( buttonAddSecClusGrpInc != null ) {
			buttonAddSecClusGrpInc.setDisable( false );
		}

	}

	public class SecClusGrpIncByQualNameComparator
	implements Comparator<ICFSecSecClusGrpIncObj>
	{
		public SecClusGrpIncByQualNameComparator() {
		}
	...
	protected SecClusGrpIncByQualNameComparator compareSecClusGrpIncByQualName = new SecClusGrpIncByQualNameComparator();

	public void refreshMe() {
		final String S_ProcName = "refreshMe";
		observableListOfSecClusGrpInc = FXCollections.observableArrayList();
		List<ICFSecSecClusGrpIncObj> page = pageCallback.pageData( null,
							null );
		Iterator<ICFSecSecClusGrpIncObj> iter = page.iterator();
		while( iter.hasNext() ) {
			observableListOfSecClusGrpInc.add( iter.next() );
