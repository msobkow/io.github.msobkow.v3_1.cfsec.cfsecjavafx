// Description: Java 25 JavaFX Picker Form implementation for SecRoleEnables.
...
/**
 *	CFSecJavaFXSecRoleEnablesPickerForm JavaFX Picker Form implementation
 *	for SecRoleEnables.
 */
public class CFSecJavaFXSecRoleEnablesPickerForm
	...
	ICFForm
{
	...
	public CFSecJavaFXSecRoleEnablesPickerForm( ICFFormManager formManager,
		...
		ICFSecJavaFXSecRoleEnablesChosen whenChosen )
	{
		...
		javafxPickerPane = argSchema.getSecRoleEnablesFactory().newPickerPane( cfFormManager, argFocus, argContainer, argPageCallback, whenChosen );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecRoleEnablesPaneCommon)javafxPickerPane).setJavaFXFocus( (ICFSecSecRoleEnablesObj)value );
	}
	...
	public Collection<ICFSecSecRoleEnablesObj> getJavaFXDataCollection() {
		ICFSecJavaFXSecRoleEnablesPaneList jplPicker = (ICFSecJavaFXSecRoleEnablesPaneList)javafxPickerPane;
		Collection<ICFSecSecRoleEnablesObj> cltn = jplPicker.getJavaFXDataCollection();
		return( cltn );
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( javafxPickerPane != null ) {
			ICFSecJavaFXSecRoleEnablesPaneCommon jpanelCommon = (ICFSecJavaFXSecRoleEnablesPaneCommon)javafxPickerPane;
