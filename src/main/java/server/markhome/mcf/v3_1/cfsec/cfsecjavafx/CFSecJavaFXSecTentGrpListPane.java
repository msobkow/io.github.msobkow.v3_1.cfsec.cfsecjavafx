// Description: Java 25 JavaFX List of Obj Pane implementation for SecTentGrp.
...
/**
 *	CFSecJavaFXSecTentGrpListPane JavaFX List of Obj Pane implementation
 *	for SecTentGrp.
 */
public class CFSecJavaFXSecTentGrpListPane
...
implements ICFSecJavaFXSecTentGrpPaneList
{
		...
		boolean sortByChain )
	{
		...
		if( observableListOfSecTentGrp != null ) {
	...
	public void adjustListButtons() {
		...
		if( buttonAddSecTentGrp != null ) {
			buttonAddSecTentGrp.setDisable( ! allowAdds );
		}
