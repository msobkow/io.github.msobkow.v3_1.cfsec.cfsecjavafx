// Description: Java 25 JavaFX Picker of Obj Pane implementation for SecRoleEnables.
...
/**
 *	CFSecJavaFXSecRoleEnablesPickerPane JavaFX Pick Obj Pane implementation
 *	for SecRoleEnables.
 */
public class CFSecJavaFXSecRoleEnablesPickerPane
extends CFBorderPane
implements ICFSecJavaFXSecRoleEnablesPaneList
{
	public static String S_FormName = "Choose Security Role Enables Group";
	...
	protected ICFSecJavaFXSecRoleEnablesChosen invokeWhenChosen = null;
	protected ICFSecSecRoleObj javafxContainer = null;
	protected CFButton buttonCancel = null;
	protected CFButton buttonChooseNone = null;
	protected CFButton buttonChooseSelected = null;
	protected ScrollPane scrollMenu = null;
	public CFSecJavaFXSecRoleEnablesPickerPane( ICFFormManager formManager,
		...
		buttonChooseNone.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseSecRoleEnables( null );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
		...
		buttonChooseSelected.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseSecRoleEnables( selectedInstance );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
