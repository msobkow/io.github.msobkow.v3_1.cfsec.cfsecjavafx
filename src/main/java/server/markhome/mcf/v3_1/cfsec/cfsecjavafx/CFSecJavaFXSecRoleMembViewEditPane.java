// Description: Java 25 JavaFX View/Edit Pane implementation for SecRoleMemb.
...
/**
 *	CFSecJavaFXSecRoleMembViewEditPane JavaFX View/Edit Pane implementation
 *	for SecRoleMemb.
 */
public class CFSecJavaFXSecRoleMembViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecRoleMembPaneCommon
{
	...
	public CFSecJavaFXSecRoleMembViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecRoleMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecRoleMembPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
