// Description: Java 25 JavaFX Add Form implementation for SecRoleMemb.
...
/**
 *	CFSecJavaFXSecRoleMembAddForm JavaFX Add Form implementation
 *	for SecRoleMemb.
 */
public class CFSecJavaFXSecRoleMembAddForm
extends CFBorderPane
implements ICFSecJavaFXSecRoleMembPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Security Role Member";
	...
	public CFSecJavaFXSecRoleMembAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecRoleMembObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecRoleMembFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecRoleMembPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecRoleMembFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecRoleMembPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecRoleMembPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
