// Description: Java 25 JavaFX Ask Delete Pane implementation for SecTentGrpInc.
...
/**
 *	CFSecJavaFXSecTentGrpIncAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecTentGrpInc.
 */
public class CFSecJavaFXSecTentGrpIncAskDeleteForm
	...
	ICFForm
{
	...
	public CFSecJavaFXSecTentGrpIncAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentGrpIncObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecTentGrpIncObj obj = getJavaFXFocusAsSecTentGrpInc();
					ICFSecSecTentGrpIncEditObj editObj = (ICFSecSecTentGrpIncEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecTentGrpIncFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecTentGrpInc( ICFSecSecTentGrpIncObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecTentGrpIncPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecTentGrpIncPaneCommon)attrPane).setPaneMode( value );
		}
	}
