// Description: Java 25 JavaFX Picker of Obj Pane implementation for ServiceType.
...
implements ICFSecJavaFXServiceTypePaneList
{
	...
	protected TableColumn<ICFSecServiceTypeObj, CFLibDbKeyHash256> tableColumnServiceTypeId = null;
		...
		ICFSecJavaFXServiceTypeChosen whenChosen )
	{
		...
		tableColumnServiceTypeId = new TableColumn<ICFSecServiceTypeObj,CFLibDbKeyHash256>( "Service Type Id" );
		tableColumnServiceTypeId.setCellValueFactory( new Callback<CellDataFeatures<ICFSecServiceTypeObj,CFLibDbKeyHash256>,ObservableValue<CFLibDbKeyHash256> >() {
			public ObservableValue<CFLibDbKeyHash256> call( CellDataFeatures<ICFSecServiceTypeObj, CFLibDbKeyHash256> p ) {
				ICFSecServiceTypeObj obj = p.getValue();
				if( obj == null ) {
					return( null );
				}
				else {
					CFLibDbKeyHash256 value = obj.getRequiredServiceTypeId();
		...
		tableColumnServiceTypeId.setCellFactory( new Callback<TableColumn<ICFSecServiceTypeObj,CFLibDbKeyHash256>,TableCell<ICFSecServiceTypeObj,CFLibDbKeyHash256>>() {
			@Override public TableCell<ICFSecServiceTypeObj,CFLibDbKeyHash256> call(
				TableColumn<ICFSecServiceTypeObj,CFLibDbKeyHash256> arg)
			{
				return new CFDbKeyHash256TableCell<ICFSecServiceTypeObj>();
			}
		});
