// Description: Java 25 JavaFX Picker Form implementation for SecClusRoleMemb.
...
/**
 *	CFSecJavaFXSecClusRoleMembPickerForm JavaFX Picker Form implementation
 *	for SecClusRoleMemb.
 */
public class CFSecJavaFXSecClusRoleMembPickerForm
	...
	ICFForm
{
	...
	public CFSecJavaFXSecClusRoleMembPickerForm( ICFFormManager formManager,
		...
		ICFSecJavaFXSecClusRoleMembChosen whenChosen )
	{
		...
		javafxPickerPane = argSchema.getSecClusRoleMembFactory().newPickerPane( cfFormManager, argFocus, argContainer, argPageCallback, whenChosen );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecClusRoleMembPaneCommon)javafxPickerPane).setJavaFXFocus( (ICFSecSecClusRoleMembObj)value );
	}
	...
	public Collection<ICFSecSecClusRoleMembObj> getJavaFXDataCollection() {
		ICFSecJavaFXSecClusRoleMembPaneList jplPicker = (ICFSecJavaFXSecClusRoleMembPaneList)javafxPickerPane;
		Collection<ICFSecSecClusRoleMembObj> cltn = jplPicker.getJavaFXDataCollection();
		return( cltn );
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( javafxPickerPane != null ) {
			ICFSecJavaFXSecClusRoleMembPaneCommon jpanelCommon = (ICFSecJavaFXSecClusRoleMembPaneCommon)javafxPickerPane;
