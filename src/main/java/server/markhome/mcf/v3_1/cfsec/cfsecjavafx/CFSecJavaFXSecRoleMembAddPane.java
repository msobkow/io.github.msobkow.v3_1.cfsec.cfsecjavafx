// Description: Java 25 JavaFX Add Pane implementation for SecRoleMemb.
...
/**
 *	CFSecJavaFXSecRoleMembAddPane JavaFX Add Pane implementation
 *	for SecRoleMemb.
 */
public class CFSecJavaFXSecRoleMembAddPane
extends CFSplitPane
implements ICFSecJavaFXSecRoleMembPaneCommon
{
	...
	public CFSecJavaFXSecRoleMembAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecRoleMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecRoleMembPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
