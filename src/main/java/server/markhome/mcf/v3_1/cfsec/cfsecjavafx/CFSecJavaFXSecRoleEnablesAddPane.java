// Description: Java 25 JavaFX Add Pane implementation for SecRoleEnables.
...
/**
 *	CFSecJavaFXSecRoleEnablesAddPane JavaFX Add Pane implementation
 *	for SecRoleEnables.
 */
public class CFSecJavaFXSecRoleEnablesAddPane
extends CFSplitPane
implements ICFSecJavaFXSecRoleEnablesPaneCommon
{
	...
	public CFSecJavaFXSecRoleEnablesAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecRoleEnablesObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecRoleEnablesPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
