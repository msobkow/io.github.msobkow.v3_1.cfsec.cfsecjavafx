// Description: Java 25 JavaFX Add Pane implementation for SecClusGrpInc.
...
/**
 *	CFSecJavaFXSecClusGrpIncAddPane JavaFX Add Pane implementation
 *	for SecClusGrpInc.
 */
public class CFSecJavaFXSecClusGrpIncAddPane
extends CFSplitPane
implements ICFSecJavaFXSecClusGrpIncPaneCommon
{
	...
	public CFSecJavaFXSecClusGrpIncAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusGrpIncObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecClusGrpIncPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
