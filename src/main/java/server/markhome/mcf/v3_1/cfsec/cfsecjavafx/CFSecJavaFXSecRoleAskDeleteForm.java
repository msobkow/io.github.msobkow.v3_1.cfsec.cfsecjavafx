// Description: Java 25 JavaFX Ask Delete Pane implementation for SecRole.
...
/**
 *	CFSecJavaFXSecRoleAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecRole.
 */
public class CFSecJavaFXSecRoleAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecRolePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Security Role";
	...
	public CFSecJavaFXSecRoleAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecRoleObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Security Role?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecRoleObj obj = getJavaFXFocusAsSecRole();
					ICFSecSecRoleEditObj editObj = (ICFSecSecRoleEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecRoleFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecRole( ICFSecSecRoleObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecRolePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecRolePaneCommon)attrPane).setPaneMode( value );
		}
	}
