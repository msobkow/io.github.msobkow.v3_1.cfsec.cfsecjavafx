// Description: Java 25 JavaFX View/Edit Pane implementation for SecTentGrp.
...
/**
 *	CFSecJavaFXSecTentGrpViewEditPane JavaFX View/Edit Pane implementation
 *	for SecTentGrp.
 */
public class CFSecJavaFXSecTentGrpViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecTentGrpPaneCommon
{
	...
	public CFSecJavaFXSecTentGrpViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentGrpObj argFocus ) {
		...
		attrPane = argSchema.getSecTentGrpFactory().newAttrPane( cfFormManager, argFocus );
