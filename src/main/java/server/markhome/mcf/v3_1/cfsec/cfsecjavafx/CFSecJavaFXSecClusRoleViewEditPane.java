// Description: Java 25 JavaFX View/Edit Pane implementation for SecClusRole.
...
/**
 *	CFSecJavaFXSecClusRoleViewEditPane JavaFX View/Edit Pane implementation
 *	for SecClusRole.
 */
public class CFSecJavaFXSecClusRoleViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecClusRolePaneCommon
{
	...
	public CFSecJavaFXSecClusRoleViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusRoleObj argFocus ) {
		...
		attrPane = argSchema.getSecClusRoleFactory().newAttrPane( cfFormManager, argFocus );
