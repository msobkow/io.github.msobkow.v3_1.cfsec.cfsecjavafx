// Description: Java 25 JavaFX View/Edit Form implementation for SecRole.
...
/**
 *	CFSecJavaFXSecRoleViewEditForm JavaFX View/Edit Form implementation
 *	for SecRole.
 */
public class CFSecJavaFXSecRoleViewEditForm
extends CFBorderPane
implements ICFSecJavaFXSecRolePaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Security Role";
	...
	public CFSecJavaFXSecRoleViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecRoleObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getSecRoleFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecRolePaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsSecRole() != null ) {
							if( null == getJavaFXFocusAsSecRole().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecRolePaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecRolePaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
