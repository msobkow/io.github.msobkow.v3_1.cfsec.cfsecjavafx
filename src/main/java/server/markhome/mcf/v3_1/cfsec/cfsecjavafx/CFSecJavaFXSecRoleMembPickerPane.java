// Description: Java 25 JavaFX Picker of Obj Pane implementation for SecRoleMemb.
...
/**
 *	CFSecJavaFXSecRoleMembPickerPane JavaFX Pick Obj Pane implementation
 *	for SecRoleMemb.
 */
public class CFSecJavaFXSecRoleMembPickerPane
extends CFBorderPane
implements ICFSecJavaFXSecRoleMembPaneList
{
	public static String S_FormName = "Choose Security Role Member";
	...
	protected ICFSecJavaFXSecRoleMembChosen invokeWhenChosen = null;
	protected ICFSecSecRoleObj javafxContainer = null;
	protected CFButton buttonCancel = null;
	protected CFButton buttonChooseNone = null;
	protected CFButton buttonChooseSelected = null;
	protected ScrollPane scrollMenu = null;
	public CFSecJavaFXSecRoleMembPickerPane( ICFFormManager formManager,
		...
		buttonChooseNone.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseSecRoleMemb( null );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
		...
		buttonChooseSelected.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseSecRoleMemb( selectedInstance );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
