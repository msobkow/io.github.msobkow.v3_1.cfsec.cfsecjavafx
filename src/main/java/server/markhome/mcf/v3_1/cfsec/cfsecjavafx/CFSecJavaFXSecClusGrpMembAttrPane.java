...
implements ICFSecJavaFXSecClusGrpMembPaneCommon
{
		...
		extends CFLabel
	{
		public SecClusGrpIdCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.SecClusGrpMemb.AttrPane.SecClusGrpId.EffLabel"));
		}
	}
		...
		extends CFDbKeyHash256Editor
	{
		public SecClusGrpIdEditor() {
			super();
			setFieldNameInzTag( "cfsec.javafx.SecClusGrpMemb.AttrPane.SecClusGrpId.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public SecUserIdCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.SecClusGrpMemb.AttrPane.SecUserId.EffLabel"));
		}
	}
		...
		extends CFDbKeyHash256Editor
	{
		public SecUserIdEditor() {
			super();
			setFieldNameInzTag( "cfsec.javafx.SecClusGrpMemb.AttrPane.SecUserId.EffLabel" );
		}
	}
