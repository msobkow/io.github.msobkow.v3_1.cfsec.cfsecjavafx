// Description: Java 25 JavaFX List of Obj Pane implementation for SecGrpMemb.
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFSec") && backingClassCode == ICFSecSecGrpMemb.CLASS_CODE ) {
