// Description: Java 25 JavaFX Attribute Pane implementation for HostNode.
...
implements ICFSecJavaFXHostNodePaneCommon
{
		...
		extends CFLabel
	{
		public HostNodeIdCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.HostNode.AttrPane.HostNodeId.EffLabel"));
		}
	}
		...
		extends CFDbKeyHash256Editor
	{
		public HostNodeIdEditor() {
			super();
			setFieldNameInzTag( "cfsec.javafx.HostNode.AttrPane.HostNodeId.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public DescriptionCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.HostNode.AttrPane.Description.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DescriptionEditor() {
			super();
			setMaxLen( 255 );
			setFieldNameInzTag( "cfsec.javafx.HostNode.AttrPane.Description.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public HostNameCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.HostNode.AttrPane.HostName.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public HostNameEditor() {
			super();
			setMaxLen( 192 );
			setFieldNameInzTag( "cfsec.javafx.HostNode.AttrPane.HostName.EffLabel" );
		}
	}
	...
	public void populateFields()
	{
		...
		if( popObj == null ) {
			getJavaFXEditorHostNodeId().setDbKeyHash256Value( null );
		}
		else {
			getJavaFXEditorHostNodeId().setDbKeyHash256Value( popObj.getRequiredHostNodeId() );
		}
