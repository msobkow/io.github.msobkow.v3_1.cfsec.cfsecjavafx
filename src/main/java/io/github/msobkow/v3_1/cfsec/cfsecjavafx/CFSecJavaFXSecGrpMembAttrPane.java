// Description: Java 25 JavaFX Attribute Pane implementation for SecGrpMemb.
...
implements ICFSecJavaFXSecGrpMembPaneCommon
{
		...
		extends CFLabel
	{
		public SecGrpMembUserCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.SecGrpMemb.AttrPane.ParentUser.EffLabel"));
		}
	}
		...
		extends CFReferenceEditor
	{
		public SecGrpMembUserCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfsec.javafx.SecGrpMemb.AttrPane.SecGrpMembUser.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public SecGrpMembIdCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.SecGrpMemb.AttrPane.SecGrpMembId.EffLabel"));
		}
	}
		...
		extends CFDbKeyHash256Editor
	{
		public SecGrpMembIdEditor() {
			super();
			setFieldNameInzTag( "cfsec.javafx.SecGrpMemb.AttrPane.SecGrpMembId.EffLabel" );
		}
	}
	...
	public void populateFields()
	{
		...
		if( popObj == null ) {
			getJavaFXEditorSecGrpMembId().setDbKeyHash256Value( null );
		}
		else {
			getJavaFXEditorSecGrpMembId().setDbKeyHash256Value( popObj.getRequiredSecGrpMembId() );
		}
	}
