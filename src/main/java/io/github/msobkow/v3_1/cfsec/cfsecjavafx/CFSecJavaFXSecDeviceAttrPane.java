// Description: Java 25 JavaFX Attribute Pane implementation for SecDevice.
...
implements ICFSecJavaFXSecDevicePaneCommon
{
		...
		extends CFLabel
	{
		public DevNameCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.SecDevice.AttrPane.DevName.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DevNameEditor() {
			super();
			setMaxLen( 127 );
			setFieldNameInzTag( "cfsec.javafx.SecDevice.AttrPane.DevName.EffLabel" );
		}
	}
