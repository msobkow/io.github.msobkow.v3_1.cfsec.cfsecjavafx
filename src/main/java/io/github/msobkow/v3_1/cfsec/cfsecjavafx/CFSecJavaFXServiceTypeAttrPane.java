// Description: Java 25 JavaFX Attribute Pane implementation for ServiceType.
...
implements ICFSecJavaFXServiceTypePaneCommon
{
		...
		extends CFLabel
	{
		public ServiceTypeIdCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.ServiceType.AttrPane.ServiceTypeId.EffLabel"));
		}
	}
		...
		extends CFDbKeyHash256Editor
	{
		public ServiceTypeIdEditor() {
			super();
			setFieldNameInzTag( "cfsec.javafx.ServiceType.AttrPane.ServiceTypeId.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public DescriptionCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.ServiceType.AttrPane.Description.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DescriptionEditor() {
			super();
			setMaxLen( 50 );
			setFieldNameInzTag( "cfsec.javafx.ServiceType.AttrPane.Description.EffLabel" );
		}
	}
	...
	public void populateFields()
	{
		...
		if( popObj == null ) {
			getJavaFXEditorServiceTypeId().setDbKeyHash256Value( null );
		}
		else {
			getJavaFXEditorServiceTypeId().setDbKeyHash256Value( popObj.getRequiredServiceTypeId() );
		}
