// Description: Java 25 JavaFX Attribute Pane implementation for TSecGroup.
...
implements ICFSecJavaFXTSecGroupPaneCommon
{
		...
		extends CFLabel
	{
		public TSecGroupIdCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.TSecGroup.AttrPane.TSecGroupId.EffLabel"));
		}
	}
		...
		extends CFDbKeyHash256Editor
	{
		public TSecGroupIdEditor() {
			super();
			setFieldNameInzTag( "cfsec.javafx.TSecGroup.AttrPane.TSecGroupId.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public NameCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.TSecGroup.AttrPane.Name.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public NameEditor() {
			super();
			setMaxLen( 64 );
			setFieldNameInzTag( "cfsec.javafx.TSecGroup.AttrPane.Name.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public IsVisibleCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.TSecGroup.AttrPane.IsVisible.EffLabel"));
		}
	}
		...
		extends CFBoolEditor
	{
		public IsVisibleEditor() {
			super();
			setIsNullable( false );
			setFieldNameInzTag( "cfsec.javafx.TSecGroup.AttrPane.IsVisible.EffLabel" );
		}
	}
	...
	public void populateFields()
	{
		...
		if( popObj == null ) {
			getJavaFXEditorTSecGroupId().setDbKeyHash256Value( null );
		}
		else {
			getJavaFXEditorTSecGroupId().setDbKeyHash256Value( popObj.getRequiredTSecGroupId() );
		}
