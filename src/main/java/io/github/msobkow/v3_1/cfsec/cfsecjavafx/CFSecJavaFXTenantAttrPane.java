// Description: Java 25 JavaFX Attribute Pane implementation for Tenant.
...
implements ICFSecJavaFXTenantPaneCommon
{
		...
		extends CFLabel
	{
		public IdCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.Tenant.AttrPane.Id.EffLabel"));
		}
	}
		...
		extends CFDbKeyHash256Editor
	{
		public IdEditor() {
			super();
			setFieldNameInzTag( "cfsec.javafx.Tenant.AttrPane.Id.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public TenantNameCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.Tenant.AttrPane.TenantName.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public TenantNameEditor() {
			super();
			setMaxLen( 192 );
			setFieldNameInzTag( "cfsec.javafx.Tenant.AttrPane.TenantName.EffLabel" );
		}
	}
