// Description: Java 25 JavaFX Attribute Pane implementation for ISOCtry.
...
implements ICFSecJavaFXISOCtryPaneCommon
{
		...
		extends CFLabel
	{
		public ISOCtryIdCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.ISOCtry.AttrPane.ISOCtryId.EffLabel"));
		}
	}
		...
		extends CFInt16Editor
	{
		public ISOCtryIdEditor() {
			super();
			setMinValue( ICFSecISOCtry.ISOCTRYID_MIN_VALUE );
			setFieldNameInzTag( "cfsec.javafx.ISOCtry.AttrPane.ISOCtryId.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public ISOCodeCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.ISOCtry.AttrPane.ISOCode.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public ISOCodeEditor() {
			super();
			setMaxLen( 2 );
			setFieldNameInzTag( "cfsec.javafx.ISOCtry.AttrPane.ISOCode.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public NameCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.ISOCtry.AttrPane.Name.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public NameEditor() {
			super();
			setMaxLen( 64 );
			setFieldNameInzTag( "cfsec.javafx.ISOCtry.AttrPane.Name.EffLabel" );
		}
	}
