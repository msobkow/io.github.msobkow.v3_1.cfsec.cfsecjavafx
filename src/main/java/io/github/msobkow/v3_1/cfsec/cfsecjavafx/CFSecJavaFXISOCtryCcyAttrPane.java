// Description: Java 25 JavaFX Attribute Pane implementation for ISOCtryCcy.
...
implements ICFSecJavaFXISOCtryCcyPaneCommon
{
		...
		extends CFLabel
	{
		public ISOCtryCcyCcyCFLabel() {
			super();
			setText(Inz.s("cfsec.javafx.ISOCtryCcy.AttrPane.ParentCcy.EffLabel"));
		}
	}
		...
		extends CFReferenceEditor
	{
		public ISOCtryCcyCcyCFReferenceEditor() {
			...
			setFieldNameInzTag( "cfsec.javafx.ISOCtryCcy.AttrPane.ISOCtryCcyCcy.EffLabel" );
		}
	}
